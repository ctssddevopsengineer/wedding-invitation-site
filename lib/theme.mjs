...
function createTheme({ id, label, shortLabel, swatch, accent, accentDark, gold, soft, ink, dynamicFront = false, blankFront = false, dynamicLocationLabel = false, showLocationIcon = false, insideLeftMonogram = true, insideRightMonogram = false, backMonogram = true }) {
  return Object.freeze({
    id,
    label,
    shortLabel,
