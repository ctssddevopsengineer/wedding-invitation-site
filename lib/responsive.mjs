...
// 374x812 locks the strict "below 375px" inside-right scrolling boundary; 375px remains fixed-layout.
export const RESPONSIVE_VALIDATION_VIEWPORTS = Object.freeze(
  [...new Set((
    '600x1024 360x740 320x658 712x1138 800x1280 384x640 640x360 ' +
    '412x823 320x533 480x854 393x786 353x745 240x320 375x667 414x896 ' +
