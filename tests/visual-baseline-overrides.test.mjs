...
test('visual baseline overrides are limited to reviewed glyph-clipping and optical-alignment cases', () => {
  assert.deepEqual(Object.keys(overrides.cases).sort(), [
    ...
    'android-plum-details-en',
    'galaxy-a55-class-navy-details-ne',
    ...
    'laptop-navy-back-ne',
    'laptop-navy-details-bn',
    'laptop-navy-details-en',
    'laptop-navy-details-ne',
    'laptop-navy-front-ne',
    'laptop-plum-back-ne',
    'laptop-plum-details-bn',
    'laptop-plum-details-en',
    'laptop-plum-details-ne',
    ...
    'tablet-navy-back-ne',
    'tablet-navy-details-bn',
    'tablet-navy-details-en',
    'tablet-navy-details-ne',
    'tablet-navy-front-ne',
    'tablet-plum-back-ne',
    'tablet-plum-details-bn',
    'tablet-plum-details-en',
    'tablet-plum-details-ne',
