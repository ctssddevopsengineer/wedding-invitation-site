...
test('Saffron Gold keeps the monogram anchor centred, offsets only the rendered crest and deepens the foreground lettering', () => {
  ...
  assert.match(monogram, /filter:\s*brightness\(1\.12\) saturate\(\.42\) sepia\(\.2\) contrast\(1\.35\) drop-shadow\(0 0 \.85px rgba\(62, 38, 14, \.68\)\)/);
